...
export class InvoiceItem {
	...
	// Cuatro FKs quedan sin declarar: `contract_item_id`, `legacy_item_id`, `legacy_match_id` y
	// `subscription_item_id` apuntan a tablas que solo tienen espejo inerte. Se declaran cuando
	// esos espejos se promuevan (E4).
	//
