...
export class Contract {
	...
	// Quedan sin declarar dos FKs: `churn_reason_id` → `churn_reasons` y `current_step_id` →
	// `workflow_steps`. Ambas tablas solo tienen espejo inerte; se declaran al promoverlos (E4).
