...
export class Invoice {
	...
	//
	// Quedan sin declarar `legacy_invoice_id` → `invoices_legacy` y `subscription_id` →
	// `subscriptions`: ambas tablas solo tienen espejo inerte. Se declaran al promoverlos (E4).
