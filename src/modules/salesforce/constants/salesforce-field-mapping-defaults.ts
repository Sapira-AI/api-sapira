...
export const SALESFORCE_FIELD_MAPPING_DEFAULTS: Record<SalesforceFieldMappingObjectType, SalesforceFieldMappingDefault[]> = {
	client: [
		{
			object_type: 'client',
			sapira_field: 'client_number',
			salesforce_field: 'Salesforce_API_ID__c',
			is_required: true,
			data_type: 'text',
			transformation_key: 'client_number_fallback',
		},
		...
		{
			object_type: 'client',
			sapira_field: 'country',
			salesforce_field: 'DemoCountry__c',
			is_required: false,
			data_type: 'text',
			transformation_key: 'country_name',
		},
	...
	client_entity: [
		...
		},
		{
			...
			is_required: false,
			data_type: 'text',
			transformation_key: 'legal_address_concat',
		},
		{
			object_type: 'client_entity',
			sapira_field: 'country',
		...
		{
			object_type: 'client_entity',
			sapira_field: 'economic_activity',
			salesforce_field: 'Industria_sector__c',
			is_required: false,
			data_type: 'text',
		},
		{
	...
	opportunity: [
		{
			...
			sapira_field: 'quote_number',
			salesforce_field: 'id_largo_oportunidad__c',
			is_required: false,
			data_type: 'text',
		...
		{
			object_type: 'opportunity',
			sapira_field: 'quote_date',
			salesforce_field: 'CreatedDate',
			is_required: false,
			data_type: 'date',
			transformation_key: 'quote_date_with_close_fallback',
		},
		{
			object_type: 'opportunity',
			sapira_field: 'booking_date',
			salesforce_field: 'CloseDate',
			is_required: false,
			data_type: 'date',
			transformation_key: 'salesforce_date',
		},
		{
			object_type: 'opportunity',
		...
		{
			object_type: 'opportunity',
			sapira_field: 'payment_terms',
			salesforce_field: 'Account.Plazos_de_pago__c',
			is_required: false,
			data_type: 'text',
		},
		{
			...
			is_required: false,
			data_type: 'boolean',
			transformation_key: 'salesforce_boolean',
		},
		{
			object_type: 'opportunity',
		...
		{
			object_type: 'opportunity',
			sapira_field: 'currency',
			salesforce_field: 'CurrencyIsoCode',
			is_required: false,
			data_type: 'text',
			default_value: 'USD',
			transformation_key: 'direct',
		...
		{
			object_type: 'opportunity',
			sapira_field: 'salesforce_opportunity_id',
			salesforce_field: 'Id',
			is_required: true,
			data_type: 'text',
			transformation_key: 'direct',
	...
	line_item: [
		{
			...
			sapira_field: 'quote_item_number',
			salesforce_field: 'Id',
			is_required: true,
			data_type: 'text',
			transformation_key: 'direct',
		...
		{
			object_type: 'line_item',
			sapira_field: 'salesforce_line_item_id',
			salesforce_field: 'Id',
			is_required: true,
			data_type: 'text',
			transformation_key: 'direct',
		...
		{
			object_type: 'line_item',
			sapira_field: 'salesforce_product_id',
			salesforce_field: 'Product2Id',
			is_required: false,
			data_type: 'text',
			transformation_key: 'direct',
		},
		{
			object_type: 'line_item',
			sapira_field: 'product_name',
			salesforce_field: 'Product2.Name',
			is_required: true,
			data_type: 'text',
			transformation_key: 'direct',
		},
		{
			object_type: 'line_item',
			sapira_field: 'item_type',
			salesforce_field: 'Calculo_para_facturaci_n__c',
			is_required: false,
			data_type: 'text',
			transformation_key: 'direct',
		},
		{
			object_type: 'line_item',
			sapira_field: 'unit_of_measure',
			salesforce_field: 'Unidad_facturada__c',
			is_required: false,
			data_type: 'text',
			transformation_key: 'direct',
		},
		{
			object_type: 'line_item',
			sapira_field: 'unit_price',
			salesforce_field: 'UnitPrice',
			is_required: false,
			data_type: 'numeric',
			transformation_key: 'direct',
		},
		{
			object_type: 'line_item',
			sapira_field: 'quantity',
			salesforce_field: 'Quantity',
			is_required: false,
			data_type: 'numeric',
			default_value: '1',
			transformation_key: 'direct',
		...
		{
			object_type: 'line_item',
			sapira_field: 'start_date',
			salesforce_field: 'Fecha_de_inicio__c',
			is_required: false,
			data_type: 'date',
			transformation_key: 'salesforce_date',
		},
		{
			object_type: 'line_item',
			sapira_field: 'end_date',
			salesforce_field: 'Fecha_de_Fin__c',
			is_required: false,
			data_type: 'date',
			transformation_key: 'salesforce_date',
		},
		{
			object_type: 'line_item',
			sapira_field: 'is_recurring',
			salesforce_field: 'Recurrencia__c',
			is_required: false,
			data_type: 'boolean',
			transformation_key: 'recurring_flag',
		},
		{
			object_type: 'line_item',
			sapira_field: 'custom_fields',
			salesforce_field: 'custom_fields',
			is_required: false,
			data_type: 'jsonb',
			transformation_key: 'custom_fields_bundle',
		},
	],
	product: [
...
export const SALESFORCE_FIELD_MAPPING_OBJECT_TYPES: SalesforceFieldMappingObjectType[] = [
	'client',
	'client_entity',
	'opportunity',
	'line_item',
