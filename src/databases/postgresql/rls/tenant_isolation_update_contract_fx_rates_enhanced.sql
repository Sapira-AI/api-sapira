DROP POLICY IF EXISTS "tenant_isolation_update_contract_fx_rates_enhanced" ON "public"."contract_fx_period_rates";

CREATE POLICY "tenant_isolation_update_contract_fx_rates_enhanced"
