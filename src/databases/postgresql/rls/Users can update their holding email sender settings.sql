DROP POLICY IF EXISTS "Users can update their holding email sender settings" ON "public"."holding_email_sender_settings";

CREATE POLICY "Users can update their holding email sender settings"
