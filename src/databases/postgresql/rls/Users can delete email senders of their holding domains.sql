DROP POLICY IF EXISTS "Users can delete email senders of their holding domains" ON "public"."email_sender_addresses";

CREATE POLICY "Users can delete email senders of their holding domains"
