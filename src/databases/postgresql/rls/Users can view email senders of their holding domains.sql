DROP POLICY IF EXISTS "Users can view email senders of their holding domains" ON "public"."email_sender_addresses";

CREATE POLICY "Users can view email senders of their holding domains"
