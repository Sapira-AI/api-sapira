...
BEGIN
  ...
  WHERE code IN (
    ...
    'VIEW_REPORTES', 'VIEW_DOCUMENTACION',
  ...
  FROM permissions
  WHERE code IN ('VIEW_DASHBOARD', 'VIEW_REPORTES', 'VIEW_DOCUMENTACION');
  ...
  WHERE code IN (
    ...
    'VIEW_CONTRATOS', 'VIEW_FACTURACION', 'VIEW_REPORTES', 'VIEW_DOCUMENTACION'
  );
  ...
  WHERE code IN (
    ...
    'VIEW_CONTRATOS', 'VIEW_REVENUE', 'VIEW_REPORTES', 'VIEW_DOCUMENTACION'
  );
  ...
  WHERE code IN (
    ...
    'VIEW_REVENUE', 'VIEW_REPORTES', 'VIEW_DOCUMENTACION'
  );
  ...
  WHERE code IN (
    'VIEW_DASHBOARD', 'VIEW_CLIENTES', 'VIEW_FACTURACION',
    'EDIT_FACTURACION', 'VIEW_REPORTES', 'VIEW_DOCUMENTACION'
  );
  ...
  WHERE code IN (
    ...
    'VIEW_REVENUE', 'EDIT_REVENUE', 'VIEW_REPORTES', 'VIEW_DOCUMENTACION',
  ...
  WHERE code IN (
    ...
    'VIEW_REPORTES', 'VIEW_DOCUMENTACION', 'VIEW_AGENTES_IA', 'VIEW_INTEGRACIONES',
    'VIEW_CONFIGURACION', 'EDIT_CONFIGURACION'
  );
  ...
  WHERE code IN (
    ...
    'VIEW_REVENUE', 'VIEW_REPORTES', 'VIEW_DOCUMENTACION', 'VIEW_AGENTES_IA', 'EDIT_AGENTES_IA',
