# Módulo 10 · Integraciones — Stripe — 7 tablas de prod (2026-09-24)
...
| `stripe_subscriptions_stg` (488) | `src/databases/postgresql/entities/integraciones/stripe/stripe-subscriptions-stg.entity.ts` · `StripeSubscriptionsStg` | ⚠️ difiere de prod | — | — | — | nombre de PK `stripe_subscriptions_stg_pkey` |
...
| `stripe_customers_bigquery` (26407) | `src/databases/postgresql/entities/integraciones/stripe/stripe-customer-bigquery.entity.ts` · `StripeCustomerBigQuery` | ⚠️ difiere de prod | — | — | — | nombre de PK `stripe_customers_bigquery_pkey` |
