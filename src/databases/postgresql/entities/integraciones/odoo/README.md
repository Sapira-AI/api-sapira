# Módulo 10 · Integraciones — Odoo — 6 tablas de prod (2026-09-24)
...
|---|---|---|---|---|---|---|
| `odoo_connections` (3) | `src/databases/postgresql/entities/integraciones/odoo/odoo-connection.entity.ts` · `OdooConnection` | ⚠️ difiere de prod | — | — | — | nombre de PK `odoo_connections_pkey` |
| `odoo_invoices_stg` (10852) | `src/databases/postgresql/entities/integraciones/odoo/odoo-invoices-stg.entity.ts` · `OdooInvoicesStg` | ⚠️ difiere de prod | — | — | — | nombre de PK `odoo_invoices_stg_pkey`<br>CHECK `odoo_invoices_stg_processing_status_check` |
| `odoo_invoice_lines_stg` (13737) | `src/databases/postgresql/entities/integraciones/odoo/odoo-invoice-lines-stg.entity.ts` · `OdooInvoiceLinesStg` | ⚠️ difiere de prod | — | — | — | nombre de PK `odoo_invoice_lines_stg_pkey`<br>CHECK `odoo_invoice_lines_stg_processing_status_check` |
| `odoo_partners_stg` (825) | `src/databases/postgresql/entities/integraciones/odoo/odoo-partners-stg.entity.ts` · `OdooPartnersStg` | ⚠️ difiere de prod | — | — | `id`: default `None` vs DB `nextval('odoo_partners_stg_id_seq'::regclass)` | nombre de PK `odoo_partners_stg_pkey`<br>CHECK `odoo_partners_stg_processing_status_check`<br>índice con expresión `idx_odoo_partners_stg_raw_data_gin` |
| `odoo_product_mappings` (41) | `src/databases/postgresql/entities/integraciones/odoo/odoo-product-mapping.entity.ts` · `OdooProductMapping` | ⚠️ difiere de prod | — | — | — | nombre de PK `odoo_product_mappings_pkey` |
