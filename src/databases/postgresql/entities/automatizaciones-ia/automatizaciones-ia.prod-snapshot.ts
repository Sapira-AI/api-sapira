...
export const AUTOMATIZACIONES_IA_PROD_SNAPSHOT: Record<string, ProdTableSnapshot> = {
	...
	"ai_agent_configs": {
		...
		"uniques": {
			"ai_agent_configs_agent_id_key_key": [
				"agent_id",
				"key"
			]
		},
	...
	"client_agent_configs": {
		...
		"uniques": {
			"client_agent_configs_holding_id_client_id_agent_type_key": [
				"holding_id",
				"client_id",
				"agent_type"
			]
		...
		"checks": [
			"client_agent_configs_agent_type_check"
		],
		"indexes": {
	...
	"ai_messages": {
		...
		"uniques": {},
		"checks": [
			"ai_messages_channel_check",
			"ai_messages_direction_check"
		],
		"indexes": {}
	},
	"rag_documents": {
