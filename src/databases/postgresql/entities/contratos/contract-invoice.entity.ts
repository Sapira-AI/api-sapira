...
/**
 * Entity de `public.contract_invoices` — generado desde prod en vivo (`hklompkypzqtglprfobu`, MCP Supabase, 2026-08-22). 5339 filas · RLS on.
...
export class ContractInvoice {
	...
	satisfiedByLegacy?: InvoicesLegacy; // de otro módulo
