...
/**
 * Espejo de `public.contract_billing_splits` — generado desde prod en vivo (`hklompkypzqtglprfobu`, MCP Supabase, 2026-08-22). filas desconocidas (tabla sin ANALYZE) · RLS on.
...
export class ContractBillingSplit {
	...
	@ManyToOne(() => Company)
	@JoinColumn({ name: 'billing_company_id', referencedColumnName: 'id', foreignKeyConstraintName: 'contract_billing_splits_billing_company_id_fkey' })
