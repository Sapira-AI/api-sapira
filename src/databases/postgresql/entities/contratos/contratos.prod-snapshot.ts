...
export const CONTRATOS_PROD_SNAPSHOT: Record<string, ProdTableSnapshot> = {
	...
	"contract_change_log": {
		...
		"uniques": {},
		"checks": [
			"contract_change_log_change_type_check"
		],
		"indexes": {}
	},
	"contract_item_change_log": {
		...
		"uniques": {},
		"checks": [
			"contract_item_change_log_change_type_check"
		],
		"indexes": {}
	},
	"contract_workflow_history": {
		...
		"uniques": {},
		"checks": [
			"contract_workflow_history_transition_type_check"
		],
		"indexes": {
	...
	"contract_billing_splits": {
		...
		"uniques": {},
		"checks": [
			"contract_billing_splits_percent_allocation_check",
			"valid_date_range"
		],
		"indexes": {
	...
	"churn_reasons": {
		...
		"foreignKeys": {},
		"uniques": {
			"churn_reasons_holding_id_name_key": [
				"holding_id",
				"name"
			]
		},
