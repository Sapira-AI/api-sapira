...
export const FX_PROD_SNAPSHOT: Record<string, ProdTableSnapshot> = {
	"holding_fx_period_rates": {
		...
		"uniques": {
			"holding_fx_period_rates_unique_period": [
				"holding_id",
				"from_currency",
				"to_currency",
				"period_start",
		...
		"checks": [
			"holding_fx_period_rates_period_check",
			"holding_fx_period_rates_rate_check"
		],
		"indexes": {
	...
	"contract_fx_period_rates": {
		...
		"uniques": {},
		"checks": [
			"contract_fx_period_rates_check",
			"contract_fx_period_rates_rate_check"
		],
		"indexes": {
