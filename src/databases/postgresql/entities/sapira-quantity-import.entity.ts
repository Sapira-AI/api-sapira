...
export class SapiraQuantityImport {
	...
	// Las FKs a `quantities` y `contract_items` se crean a mano en la migración: ambas tablas
	// solo tienen espejo inerte, y declararlas acá los cargaría en runtime saltándose la
	// promoción. Cuando se promuevan (E4), se declaran acá y `schema:log` deja de pedirlas.
}
