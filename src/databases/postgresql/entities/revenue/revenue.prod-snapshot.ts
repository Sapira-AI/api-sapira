...
export const REVENUE_PROD_SNAPSHOT: Record<string, ProdTableSnapshot> = {
	"revenue_schedule_monthly": {
		...
		"uniques": {
			"revenue_schedule_monthly_contract_item_period_momentum_key": [
				"contract_id",
				"contract_item_id",
				"period_month",
				"momentum"
		...
		"checks": [
			...
			"rsm_contract_or_subscription_required"
		],
		"indexes": {
	...
	"revenue_rules": {
		...
		"uniques": {},
		"checks": [
			"revenue_rules_target_type_check"
		],
		"indexes": {}
	},
	"mrr_adjustments": {
	...
	"accounting_period_cutoff": {
		...
		"uniques": {
			"accounting_period_cutoff_holding_id_company_id_key": [
				"holding_id",
				"company_id"
			]
		},
		"checks": [
			"accounting_period_cutoff_last_action_check"
		],
		"indexes": {
			"idx_cutoff_lookup": {
				"columns": [
	...
	"accounting_period_events": {
		...
		"uniques": {},
		"checks": [
			"accounting_period_events_action_check",
			"accounting_period_events_reason_check"
		],
		"indexes": {}
	}
};
