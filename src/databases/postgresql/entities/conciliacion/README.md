...
| `bank_upload_batches` (0, RLS on) | `bank-upload-batch.espejo.ts` · `BankUploadBatch` | 11 | `bank_upload_batches_pkey` (id) | — | `bank_upload_batches_status_check` | `bank_upload_batches_bank_account_id_fkey` → company_bank_accounts<br>`bank_upload_batches_uploaded_by_fkey` → users | — | — | 4 |
