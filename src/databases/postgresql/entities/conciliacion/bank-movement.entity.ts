...
import { BankUploadBatch } from './bank-upload-batch.entity';

/**
 * Entity de `public.bank_movements` — generado desde prod en vivo (`hklompkypzqtglprfobu`, MCP Supabase, 2026-08-22). 158 filas · RLS on.
