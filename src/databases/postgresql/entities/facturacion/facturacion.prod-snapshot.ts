...
export const FACTURACION_PROD_SNAPSHOT: Record<string, ProdTableSnapshot> = {
	...
	"invoice_collection_settings": {
		...
		"foreignKeys": {},
		"uniques": {
			"invoice_collection_settings_holding_id_key": [
				"holding_id"
			]
		},
		"checks": [],
	...
	"invoice_reference_links": {
		...
		"uniques": {
			"invoice_reference_links_invoice_id_reference_id_key": [
				"invoice_id",
				"reference_id"
			]
		},
	...
	"overdue_check_log": {
		...
		"uniques": {},
		"checks": [
			"overdue_check_log_status_check"
		],
		"indexes": {}
	},
	...
	"quantities": {
		...
		"uniques": {
			"quantities_unique_item_period": [
				"contract_item_id",
				"period"
			]
		},
		"checks": [
			"quantities_period_check",
			"quantities_quantity_check",
			"quantities_unit_price_check"
		],
		"indexes": {
	...
	"reference_requests": {
		...
		"uniques": {},
		"checks": [
			"reference_requests_reference_type_check",
