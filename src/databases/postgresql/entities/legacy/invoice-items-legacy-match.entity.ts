 ...
 */
@Entity({ name: 'invoice_items_legacy_match', comment: 'Asignaciones de líneas legacy a contract_items (permite splits)' })
...
export class InvoiceItemsLegacyMatch {
	...
	@Column({ type: 'uuid', comment: 'Holding ID para seguridad multi-tenant', nullable: false })
	holding_id: string;
