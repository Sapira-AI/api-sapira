...
export const LEGACY_PROD_SNAPSHOT: Record<string, ProdTableSnapshot> = {
	"invoices_legacy": {
		...
		"uniques": {
			"invoices_legacy_holding_invoice_number_unique": [
				"holding_id",
				"invoice_number"
			],
			"invoices_legacy_holding_odoo_integration_key": [
				"holding_id",
				"odoo_integration_id"
			]
		},
		"checks": [
			...
			"invoices_legacy_source_type_check",
			"invoices_legacy_status_check"
		],
		"indexes": {
	...
	"invoice_items_legacy": {
		...
		"uniques": {
			"invoice_items_legacy_holding_odoo_line_id_key": [
				"holding_id",
				"odoo_line_id"
			]
		},
	...
	"invoice_items_legacy_match": {
		...
		"uniques": {},
		"checks": [
			"invoice_items_legacy_match_status_check",
			"match_amount_positive"
		],
		"indexes": {
	...
	"mrr_legacy": {
		...
		"uniques": {
			"mrr_legacy_invoice_item_legacy_id_split_index_period_month_key": [
				"invoice_item_legacy_id",
				"split_index",
				"period_month"
			]
